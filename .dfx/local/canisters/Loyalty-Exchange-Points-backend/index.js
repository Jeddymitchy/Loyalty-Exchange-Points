...
import { idlFactory } from './Loyalty-Exchange-Points-backend.did.js';
export { idlFactory } from './Loyalty-Exchange-Points-backend.did.js';
// CANISTER_ID is replaced by webpack based on node environment
export const canisterId = process.env.CANISTER_ID_LOYALTY_EXCHANGE_POINTS_BACKEND;
 ...
 * @return {import("@dfinity/agent").ActorSubclass<import("./Loyalty-Exchange-Points-backend.did.js")._SERVICE>}
 */
...
/**
 * A ready-to-use agent for the Loyalty-Exchange-Points-backend canister
 * @type {import("@dfinity/agent").ActorSubclass<import("./Loyalty-Exchange-Points-backend.did.js")._SERVICE>}
 */
export const Loyalty_Exchange_Points_backend = createActor(canisterId);
